import { basic14 } from '../14/basic';
import { advanced14 } from '../14/advanced';
...
describe('Day 14 tests', () => {
  ...
  describe('Day 14 utils tests', () => {
    ...
    test('should create test cave map with correct sizes', () => {
      expect(testCaveModel.size).toStrictEqual(10);
    });
  ...
  describe('Day 14 basic tests', () => {
    test('test input should return correct answer', async () => {
      return await basic14(TEST_INPUT, false).then(data => {
  ...
  describe('Day 14 advanced tests', () => {
    test('test input should return correct answer', async () => {
      return await advanced14(TEST_INPUT, false).then(data => {
        expect(data).toStrictEqual(93);
      });
    });
  });
});
